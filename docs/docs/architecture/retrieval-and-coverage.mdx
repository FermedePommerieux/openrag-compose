...
The fork exposes focused ranked discovery, verified reading of one selected
document, and exhaustive investigation of a query-defined documentary scope as
separate server-side paths. The word “exhaustive” is always relative to the
